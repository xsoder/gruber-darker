...
call <sid>hi('Conditional',   s:gruberRed,        '',            '',          '')
call <sid>hi('Constant',      s:gruberQuartz,     '',            '',          '')
call <sid>hi('Define',        s:gruberRed,        '',            '',          '')
...
call <sid>hi('Include',       s:gruberRed,        '',            '',          '')
call <sid>hi('Keyword',       s:gruberRed,        '',            '',          '')
call <sid>hi('Label',         s:gruberRed,        '',            '',          '')
call <sid>hi('Number',        s:gruberQuartz,     '',            '',          '')
call <sid>hi('Operator',      s:gruberFG,         '',            '',          '')
call <sid>hi('PreProc',       s:gruberRed,        '',            '',          '')
call <sid>hi('Repeat',        s:gruberRed,        '',            '',          '')
call <sid>hi('Special',       s:gruberMain,       '',            '',          '')
call <sid>hi('SpecialChar',   s:gruberMain,       '',            '',          '')
call <sid>hi('Statement',     s:gruberRed,        '',            '',          '')
call <sid>hi('StorageClass',  s:gruberRed,        '',            '',          '')
call <sid>hi('String',        s:gruberGreen,      '',            '',          '')
call <sid>hi('Structure',     s:gruberRed,        '',            '',          '')
...
call <sid>hi('shStatement',   s:gruberRed,        '',            '',          '')
call <sid>hi('shConditional', s:gruberRed,        '',            '',          '')
call <sid>hi('shRepeat',      s:gruberRed,        '',            '',          '')
call <sid>hi('shKeyword',     s:gruberRed,        '',            '',          '')
call <sid>hi('shTestOpr',     s:gruberRed,        '',            '',          '')
...
call <sid>hi('hsTypeDef',     s:gruberRed,        '',            '',          '')
call <sid>hi('hsStructure',   s:gruberRed,        '',            '',          '')
call <sid>hi('hsStatement',   s:gruberRed,        '',            '',          '')
call <sid>hi('hsconditional', s:gruberRed,        '',            '',          '')

" Java Highlighting
call <sid>hi('javaConstant',    s:gruberQuartz,   '',            '',          '')
call <sid>hi('javaConditional', s:gruberRed,      '',            '',          '')
call <sid>hi('javaOperator',    s:gruberFG,       '',            '',          '')
call <sid>hi('javaExceptions',  s:gruberRed,      '',            '',          '')
call <sid>hi('javaAssert',      s:gruberRed,      '',            '',          '')
call <sid>hi('javaClassDecl',   s:gruberRed,      '',            '',          '')
call <sid>hi('javaBraces',      s:gruberFG,       '',            '',          '')
call <sid>hi('javaLangObject',  s:gruberFG,       '',            '',          '')
call <sid>hi('javaType',        s:gruberMain,     '',            '',          '')

" Python Highlighting
call <sid>hi('pythonRepeat',     s:gruberRed,     '',            '',          '')
call <sid>hi('pythonOperator',   s:gruberFG,      '',            '',          '')
call <sid>hi('pythonException',  s:gruberRed,     '',            '',          '')
